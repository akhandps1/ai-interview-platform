/**
 * FILE: services/roadmap/agents/roadmap.agent.js
 * PURPOSE: Communicates with the LLM to generate a personalized, step-by-step learning roadmap 
 * based on the user's current resume, target role, and target salary.
 */
...
/**
 * Invokes the LLM to create the JSON structure of the roadmap.
 */
const roadmapAgent = async (state) => {
    try {
        // If the user wants to use their resume, we inject their strengths and weaknesses into the prompt
