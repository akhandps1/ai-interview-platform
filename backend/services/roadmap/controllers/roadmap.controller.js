/**
 * FILE: services/roadmap/controllers/roadmap.controller.js
 * PURPOSE: Exposes REST API endpoints for generating learning roadmaps. 
 * Heavily utilizes Redis caching so returning users can instantly view their saved roadmaps.
 */
