/**
 * FILE: frontend/src/components/resume/PreviewResume.jsx
 * PURPOSE: Core logic and configuration for PreviewResume.jsx.
 */
...
function PreviewResume({ data, onBack, user, setUser }) {
    ...
    return (
        <div className='min-h-screen bg-white text-[#0A0A0A]'>
            {/* header */}
            <div className='sticky top-0 z-20 border-b border-zinc-200 bg-white/80 backdrop-blur-xl'>
