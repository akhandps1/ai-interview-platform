/**
 * FILE: frontend/src/components/resume/ResumeForm.jsx
 * PURPOSE: A multi-step form component for the Resume Builder. 
 * Handles state updates for arrays (Experience, Projects, Education) dynamically.
 */
...
function Input({label, value, onChange, placeholder, type = "text"}){
    return(
        <div className='flex flex-col gap-1'>
            ...
            value={value}
            className='bg-white border border-zinc-300 focus:ring-2 focus:ring-indigo-500/20 text-[#0A0A0A] text-xs rounded-lg px-2.5 py-2 outline-none focus:border-indigo-500 transition-colors placeholder-black/30 shadow-[0_2px_8px_rgba(0,0,0,0.04)]'
            />
        </div>
    )
}
...
function TextArea({label, value, onChange, placeholder, rows = 3}){
    return(
        <div className='flex flex-col gap-1'>
            ...
            value={value}
            rows={rows}
            className='bg-white border border-zinc-300 focus:ring-2 focus:ring-indigo-500/20 text-[#0A0A0A] text-xs rounded-lg px-2.5 py-2 outline-none focus:border-indigo-500 transition-colors placeholder-black/30 resize-none shadow-[0_2px_8px_rgba(0,0,0,0.04)]'
            />
        </div>
    )
}
...
function EntryCard({ children, onRemove }){
    return(
        <div className='relative overflow-hidden bg-[#F8F9FA] border border-zinc-200 rounded-xl p-3 shadow-[0_2px_10px_rgba(0,0,0,0.05)]'>
