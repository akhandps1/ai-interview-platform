/**
 * FILE: frontend/src/apis/interview.api.js
 * PURPOSE: Contains API wrapper functions for interacting with the Interview microservice.
 * Handles starting interviews, fetching history, and submitting answers.
 */
